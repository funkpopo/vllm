...
# Local and fetched sources both need rewritten imports so the installed
# package does not depend on a separate flash_attn installation.
install(CODE "
  set(CUTE_DST_DIR \"\${CMAKE_INSTALL_PREFIX}/vllm/vllm_flash_attn/cute\")
  # Replace links created by older local-source installs without editing the source.
  if(IS_SYMLINK \"\${CUTE_DST_DIR}\")
    file(REMOVE \"\${CUTE_DST_DIR}\")
  endif()
  ...
  foreach(SRC_FILE \${CUTE_PY_FILES})
    ...
    set(DST_FILE \"\${CUTE_DST_DIR}/\${REL_PATH}\")
